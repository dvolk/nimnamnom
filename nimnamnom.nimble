...
task runr, "Runs nimnamnom for current platform":
 exec "nim c -r -d:release -o:nimnamnom src/nimnamnom.nim"

task rund, "Runs debug nimnamnom for current platform":
 exec "nim c -r -d:debug -o:nimnamnom src/nimnamnom.nim"

task release, "Builds nimnamnom for current platform":
 exec "nim c -d:release -o:nimnamnom src/nimnamnom.nim"

task debug, "Builds debug nimnamnom for current platform":
 exec "nim c -d:debug -o:nimnamnom_debug src/nimnamnom.nim"

task web, "Builds nimnamnom for current web":
 exec "nim js -d:release -o:nimnamnom.js src/nimnamnom.nim"

task webd, "Builds debug nimnamnom for current web":
 exec "nim js -d:debug -o:nimnamnom.js src/nimnamnom.nim"
